...
import org.littleshoot.proxy.ProxyUsernameAndPassword;
...
public class DefaultHttpProxyServer implements HttpProxyServer {
     ...
     */
    private final NDNAgent agent;
    private final AutonymToPseudo atp;
    ...
    private DefaultHttpProxyServer(ServerGroup serverGroup,
        ...
        //////////////////////////////////////////////////
        // This is an extension of NDNProxy. Written by Zhaogeng.
        this.agent = new NDNAgent();
        agent.open();
        this.atp = new AutonymToPseudo(2000);
        atp.open();
        ///////////////////////////////////////////////////
    }
    ...
    private static class DefaultHttpProxyServerBootstrap implements
        ...
        private DefaultHttpProxyServerBootstrap(Properties props) {
            ...
            this.connectTimeout = ProxyUtils.extractInt(props,
                    "connect_timeout", 0);
            this.port = ProxyUtils.extractInt(props, "port", 8080);
            if(ProxyUtils.extractBooleanDefaultFalse(props, "needauthenticate")){
            	this.proxyAuthenticator = new ProxyUsernameAndPassword(
                		props.getProperty("username", "username"),
